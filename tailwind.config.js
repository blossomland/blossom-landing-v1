  ...
  theme: {
    extend: {
      backgroundImage: {
        "bg-01": "var(--bg-01)",
        "bg-02": "var(--bg-02)",
        "p-bg-linear": "var(--p-bg-linear)",
        "gradient-01": "var(--gradient-01)",
        "blossom-01": "var(--blossom-01)",
        "tree": "var(--tree)",
        "business-development": "var(--business-development)",
        "community": "var(--community)",
        "creative": "var(--creative)",
        "data-science": "var(--data-science)",
        "developer-relations": "var(--developer-relations)",
        "finance": "var(--finance)",
        "founder": "var(--founder)",
        "journalist": "var(--journalist)",
        "marketing": "var(--marketing)",
        "math": "var(--math)",
        "meme-maker": "var(--meme-maker)",
        "operations": "var(--operations)",
        "product": "var(--product)",
        "project-management": "var(--project-management)",
        "researcher": "var(--researcher)",
        "west-ham": "var(--west-ham)",
      },
      fontSize: {
        xs: '8px',
        sm: '0.813rem',
